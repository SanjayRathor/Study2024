...
-(void)viewWillAppear:(BOOL)animated {
    ...
    _addressTextField.text= @"sanjayrathore36@sip.linphone.org";
    _domainTextField.text= @"sip.linphone.org";
    _userNameTextField.text=@"sanjayrathore36";
    _passwordTextField.text=@"Times@123";
    _proxyTextField.text=@"sip.linphone.org";
    _portNumberTextField.text = @"5060";
     
    
//    _addressTextField.text= @"ashutoshfb@sip.linphone.org";
//    _domainTextField.text= @"sip.linphone.org";
//    _userNameTextField.text=@"ashutoshfb";
//    _passwordTextField.text=@"Mom#papa123";
//    _proxyTextField.text=@"sip.linphone.org";
//    _portNumberTextField.text = @"5060";
