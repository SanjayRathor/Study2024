...
//NSString *idSIP = @"sip:sanjayrathore36@sip.linphone.org";
//NSString *uri = @"sip:sip.linphone.org";
//NSString *scheme = @"digest";
//NSString *realm = @"*";
//NSString *username = @"sanjayrathore36";
//NSString *password = @"Times@123";

NSString *idSIP = @"sip:sohamshuklalko@sip.linphone.org";
NSString *uri = @"sip:sip.linphone.org";
NSString *scheme = @"digest";
NSString *realm = @"*";
NSString *username = @"sohamshuklalko";
NSString *password = @"Times@123";
