...
@objcMembers class Items: NSObject, Codable {
    ...
    let howMuchCanPay: Int
    let secondTeam: String?
    let startDate, firstTeam, followedArtist, mainArtist:String
    ...
    init(campDescription: String, campImage: String, campName: String, campType: Int, campTypeName: String, campaignID: Int, cityID: Int, countryID: Int, endDate: String, eventID: Int, eventName: String, fandomPoint: String, firstTeam: String, followedArtist: String, howMuchCanPay: Int, mainArtist: String, secondTeam: String?, startDate: String, stateID: Int, status: Int, engage: Int, resultFandomPoint: String, islike: Int, pointMade: Int, shareURL: String) {
