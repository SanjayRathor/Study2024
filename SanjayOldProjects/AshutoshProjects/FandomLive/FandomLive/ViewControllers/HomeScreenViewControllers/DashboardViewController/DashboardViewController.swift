...
class DashboardViewController: SRBaseViewController {
    ...
    private let kBannerIdentifier:String = "BannersTableViewCell"
    private let kTrendingIdentifier:String = "TrendingEventsTableViewCell"
    private let kLatestIdentifier:String = "LatestNewsTableViewCell"
    ...
    override func viewDidLoad() {
        ...
        gradientImage.image = FandomGradient.gradientImage()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.tableView.visibleCells.forEach { (tableCell) in
            if let cell = tableCell as? TrendingEventsTableViewCell {
                cell.forceUpdate()
            }
        }
    }
...
extension DashboardViewController {
    ...
    func goToVotingsVC(votingcampaign:Votingcampaign) {
        ...
        viewController.vatingcampaign = votingcampaign
