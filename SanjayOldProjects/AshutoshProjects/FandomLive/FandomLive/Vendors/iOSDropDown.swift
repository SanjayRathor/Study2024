...
open class DropDown : UITextField{
    ...
    @IBInspectable public var aborderColor: UIColor =  UIColor.lightGray {
        didSet {
            layer.borderColor = aborderColor.cgColor
        }
    }
    ...
    @IBInspectable public var aborderWidth: CGFloat = 0.0 {
        didSet {
            layer.borderWidth = borderWidth
        }
    }

    @IBInspectable public var acornerRadius: CGFloat = 5.0 {
        didSet {
