...
@objcMembers class Comments: NSObject, Codable {
    ...
    let isLike, topicID, totalLike, totalReply: Int
    ...
    init(comment: String, commentID: Int, dateTime: String, image: String, isLike: Int, topicID: Int, totalLike: Int, totalReply: Int, userID: String, userName: String) {
