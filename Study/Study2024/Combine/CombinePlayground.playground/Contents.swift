...
/*
 ...
 var numbers = [-15, 4, 3, 2, 1, -1, 7, 8, 9, 10]
 ...
 print("Finished with Oh No! \(error)")
 case .finished:
 ...
 enum SimpleError: Error { case error }
 let url = URL(string: "https://www.vadimbulavindddd.com")
 ...
 let url = URL(string: "https://gist.githubusercontent.com/gabhisekdev/21bacd8cd0fb8a7c2c3efe133c1c1ebc/raw/27840b8bfb9b7762ad04b443b550f1e52a641e25/CombineErrorHandling_retry.swift")
 return URLSession.shared.dataTaskPublisher(for: url!)
 })
 .replaceError(with: "asdmlamsdmdas")
